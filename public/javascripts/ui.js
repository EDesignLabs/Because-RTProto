...
define(["realtime-client-utils", "workspace-view", "control-view"], function(util, WorkspaceView, ControlView) {
  ...
  */
  ...
  onFileLoaded = function(doc) {
    var addContextButton, addMarkerButton, addNoteButton, backgroundImage, closeModalButton, collaborators, collaboratorsChanged, context, controlView, data, deleteTool, desc, dispatcher, displayContextCreator, displayNoteCreator, getMe, markers, model, moveTool, notes, notesElement, root, title, url, workspaceView;
    model = doc.getModel();
    root = model.getRoot();
    ...
    addContextButton.click(function(e) {
      var documentDesc, documentTitle, imageUrl;
      $("#note-creator").hide();
      imageUrl = $("#image-url");
